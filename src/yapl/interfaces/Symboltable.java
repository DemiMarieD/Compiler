 ...
 * supports efficient searching for symbol names (e.g. a HashMap). The top
 ...
 * interface. The SymboltableImpl methods specify which error number should be
...
public interface Symboltable {
	...
	/**
	 * Add a new SymbolImpl to the current scope. Sets the global symbol property
